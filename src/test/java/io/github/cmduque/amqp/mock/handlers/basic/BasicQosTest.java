...
@PrepareForTest({IOUtils.class, BasicQos.class})
public class BasicQosTest {
    @Test
    public void handleMethodMustWriteBasicQosOkMethod() throws Exception {
        int channelNumber = 2;
        ...
        AMQImpl.Basic.QosOk response = mock(AMQImpl.Basic.QosOk.class);
        whenNew(AMQImpl.Basic.QosOk.class).withNoArguments().thenReturn(response);
        BasicQos methodHandler = new BasicQos();
