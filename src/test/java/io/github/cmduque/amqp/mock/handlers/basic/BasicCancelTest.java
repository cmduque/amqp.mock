...
@PrepareForTest({IOUtils.class, BasicCancel.class})
public class BasicCancelTest {
    @Test
    public void handleMethodMustWriteBasicCancelOkMethod() throws Exception {
        int channelNumber = 2;
        ...
        AMQImpl.Basic.CancelOk response = mock(AMQImpl.Basic.CancelOk.class);
        whenNew(AMQImpl.Basic.CancelOk.class).withArguments(serverConfig.getConsumerTag()).thenReturn(response);
        BasicCancel methodHandler = new BasicCancel();
