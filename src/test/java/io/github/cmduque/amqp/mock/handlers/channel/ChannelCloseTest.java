...
@PrepareForTest({IOUtils.class, ChannelClose.class})
public class ChannelCloseTest {
    @Test
    public void handleMethodMustWriteChannelCloseOkMethod() throws Exception {
        int channelNumber = 2;
        ...
        AMQImpl.Channel.CloseOk response = mock(AMQImpl.Channel.CloseOk.class);
        whenNew(AMQImpl.Channel.CloseOk.class).withNoArguments().thenReturn(response);
        ChannelClose methodHandler = new ChannelClose();
