...
public class ConnectionClose implements IMethodHandler<AMQImpl.Connection.Close> {
    @Override
    public void handleMethod(ClientHandler clientHandler, int channelNumber, AMQImpl.Connection.Close method) throws IOException {
        AMQImpl.Connection.CloseOk response = new AMQImpl.Connection.CloseOk();
