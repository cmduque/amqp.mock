...
public class QueueBind implements IMethodHandler<AMQImpl.Queue.Bind> {
    @Override
    public void handleMethod(ClientHandler clientHandler, int channelNumber, AMQImpl.Queue.Bind method) throws IOException {
        AMQImpl.Queue.BindOk response = new AMQImpl.Queue.BindOk();
