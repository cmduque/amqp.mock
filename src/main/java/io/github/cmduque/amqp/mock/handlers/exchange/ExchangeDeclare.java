...
public class ExchangeDeclare implements IMethodHandler<AMQImpl.Exchange.Declare> {
    @Override
    public void handleMethod(ClientHandler clientHandler, int channelNumber, AMQImpl.Exchange.Declare method) throws IOException {
        AMQImpl.Exchange.DeclareOk response = new AMQImpl.Exchange.DeclareOk();
