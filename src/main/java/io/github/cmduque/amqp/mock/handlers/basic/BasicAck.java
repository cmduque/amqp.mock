...
public class BasicAck implements IMethodHandler<AMQImpl.Basic.Ack> {
    @Override
    public void handleMethod(ClientHandler clientHandler, int channelNumber, AMQImpl.Basic.Ack method) {
