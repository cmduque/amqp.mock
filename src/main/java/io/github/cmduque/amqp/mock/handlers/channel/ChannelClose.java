...
public class ChannelClose implements IMethodHandler<AMQImpl.Channel.Close> {
    @Override
    public void handleMethod(ClientHandler clientHandler, int channelNumber, AMQImpl.Channel.Close method) throws IOException {
        AMQImpl.Channel.CloseOk response = new AMQImpl.Channel.CloseOk();
