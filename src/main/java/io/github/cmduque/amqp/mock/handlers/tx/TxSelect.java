...
public class TxSelect implements IMethodHandler<AMQImpl.Tx.Select> {
    @Override
    public void handleMethod(ClientHandler clientHandler, int channelNumber, AMQImpl.Tx.Select method) throws IOException {
        AMQImpl.Tx.SelectOk response = new AMQImpl.Tx.SelectOk();
